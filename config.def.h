...
static const Key keys[] = {
	...
	{ MODKEY,			XK_r,		spawn,		{.v = (const char *[]){ "dmenu-openfile", "-r", NULL } } },
	{ MODKEY,			XK_i,		spawn,		{.v = (const char *[]){ "firefox", NULL } } },
	{ MODKEY,			XK_o,		spawn,		{.v = (const char *[]){ "dmenu-openfile", NULL } } },
	...
	{ MODKEY,			XK_c,		spawn,		{.v = (const char *[]){ "dmenu-bluetooth", NULL } } },
	{ MODKEY,			XK_v,		spawn,		SHCMD("st -c floating -e pulsemixer && kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_b,		spawn,		{.v = (const char *[]){ "dmenu-bookmarks", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_c,		spawn,		{.v = (const char *[]){ "dmenu-wifi", NULL } } },
	{ MODKEY|ShiftMask,		XK_b,		spawn,		{.v = (const char *[]){ "dmenu-bookmarks", "-a", NULL } } },
	...
	{ MODKEY|ControlMask,		XK_b,		spawn,		{.v = (const char *[]){ "dmenu-bookmarks", "-t", NULL } } },
	{ MODKEY|ShiftMask|ControlMask,	XK_b,		spawn,		{.v = (const char *[]){ "dmenu-bookmarks", "-c", NULL } } },
	// alltags
